"""
Django settings for MC_CLOUD project.
...
SECRET_KEY = 'django-insecure-g8$oz5h*=d5xxkkocyg1hv5ir2^l)hl&os7()uof%a(h@e17qm'
...
DEFAULT_FROM_EMAIL =config('DEFAULT_FROM_EMAIL', default = 'webmaster@localhost.com')
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
